...
/**
 * @title GraphiteTrustScoreAdapter
 * @dev Adapter that connects to Graphite's Reputation system and exposes it using the TrustScore interface
 */
contract GraphiteTrustScoreAdapter is IGraphiteTrustScore {
    // The address of the Graphite Reputation contract
